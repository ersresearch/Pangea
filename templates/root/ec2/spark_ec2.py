...
DEFAULT_SPARK_GITHUB_REPO = "/home/pangea/Downloads/spark-ec2-branch-2.0"

# Default location to get the spark-ec2 scripts (and ami-list) from
DEFAULT_SPARK_EC2_GITHUB_REPO = "/home/pangea/Downloads/spark-ec2-branch-2.0"
...
def get_spark_ami(opts):
    ...
    try:
        ami = reader(open(ami_path)).read().strip()
    except:
